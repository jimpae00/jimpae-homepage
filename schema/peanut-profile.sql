...
CREATE INDEX IF NOT EXISTS idx_twitch_sub_entitlements_valid_until ON twitch_sub_entitlements(valid_until);
...
CREATE INDEX IF NOT EXISTS idx_member_videos_enabled_sort ON member_videos(enabled, sort_order, published_at);
